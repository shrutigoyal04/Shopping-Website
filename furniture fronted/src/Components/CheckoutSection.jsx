...
function CheckoutSection() {
  ...
  let [formdata, setformdata] = useState({ country: "India", firstname: "Shruti", lastname: "Goyal", companyname: "xyz", address: "Alwar", state: "Rajasthan", zip: "301701", email: "shruti@gmail.com", phoneno: "8949837624", notes: "abc" })
            ...
            <div className="col-md-6 mb-5 mb-md-0">
              ...
              <div className="p-3 p-lg-5 border bg-white">
                <div className="form-group">
                  ...
                  <select id="c_country" value={formdata["country"]} className="form-control" name="country" onChange={(e) => handleChange(e)} >
